...
ApplicationWindow {
    ...
    // logically this is part of system UI so following the same orientation rules as homescreen
            ...
            NemoDBus.DBusInterface {
                ...
                function alarm_ui_feedback_ind(event) {
                    ...
                    if (event == "powerkey" || event == "flipover") {
                        if (page.displayedAlarm.type === Alarm.Countdown
                                || page.displayedAlarm.type === Alarm.Reminder) {
