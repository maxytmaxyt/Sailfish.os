...
Item {
    ...
    readonly property string title: Util.capitalize(Format.formatDate(weekPanel.currentDate,
                                                                      Formatter.MonthNameStandalone))
    ...
    SilicaFlickable {
        ...
        onMovementEnded: {
            if (pullDownMenu && !pullDownMenu.active)
                pullDownMenuOrigin = 0
        }
        onTopMarginChanged: topMargin = pullDownMenu && pullDownMenu.active
                            ? pullDownMenu.height - flickable.pullDownMenuOrigin
                            : 0
        ...
        Column {
            ...
            WeekPanel {
                ...
                Binding on contentY {
                    when: !flickable.pullDownMenu
                          || (!flickable.pullDownMenu.active && flickable.pullDownMenuOrigin == 0)
