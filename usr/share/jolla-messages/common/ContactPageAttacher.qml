...
Item {
    ...
    property bool attachedPagePrepared: attachedPageComponent !== undefined
                                        && attachedPageComponent.status == Component.Ready
                                        && placeholderPage !== null
                                        && placeholderPage.status == PageStatus.Active
    ...
    function updatePerson() {
        ...
        attachedPageComponent = MessageUtils.attachedComponentCache ? MessageUtils.attachedComponentCache[attachedPageSource]
                                                                    : undefined
