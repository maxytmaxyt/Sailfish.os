    ...
    Image {
        ...
        function iconSource() {
            if (messagePart === undefined
                ...
                return "image://theme/icon-m-refresh?" + (message.highlighted ? Theme.highlightColor
                                                                              : Theme.primaryColor)
        ...
        Rectangle {
            anchors.fill: parent
            z: -1
            color: (showRetryIcon && attachment.status !== Thumbnail.Null) ? Theme.highlightDimmerColor
                                                                           : Theme.highlightColor
            opacity: (showRetryIcon && attachment.status !== Thumbnail.Null) ? Theme.opacityHigh
                                                                             : Theme.opacityFaint
