...
ChatTextInput {
    ...
    property bool recreateDraftEvent
    ...
    conversationTypeMenu.remoteUid: conversation.message && conversation.message.remoteUids.length
                                    ? conversation.message.remoteUids[0] : ""
    ...
    DraftEvent {
        ...
        function updateAndSave() {
            ...
            if (conversation.message.groupId >= 0) {
                ...
                groupId = conversation.message.groupId = groupManager.ensureGroupExists(conversation.message.localUid,
                                                                                        conversation.message.remoteUids)
            } else {
                return
            }
