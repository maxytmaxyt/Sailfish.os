    ...
    delegate: Item {
        ...
        Component {
            ...
            SMSMessageDelegate {
                ...
                groupFirst: !previousEvent
                            || previousEvent.direction !== model.direction
                            || previousEvent.dateAndAccountGrouping !== model.dateAndAccountGrouping
                groupLast: !nextEvent
                           || nextEvent.direction !== model.direction
                           || nextEvent.dateAndAccountGrouping !== model.dateAndAccountGrouping
            }
        }
    ...
    Component {
        ...
        Column {
            ...
            SectionHeader {
                ...
                horizontalAlignment: Text.AlignHCenter
                color: Theme.secondaryColor
                text: !modelData ? "" : MessageUtils.accountDisplayName(conversation.people[0],
                                                                        modelData.localUid,
                                                                        modelData.remoteUid)
