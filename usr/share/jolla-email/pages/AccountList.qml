    ...
    Repeater {
        ...
        delegate: ListItem {
            ...
            Image {
                ...
                // TODO: scaling images is bad
                width: Math.min(accountItem.contentHeight,
                ...
                onStatusChanged: {
                    if (accountIcon.status == Image.Error)
                        fixedIconPath = "image://theme/graphic-service-generic-mail"
                }
            }
                    ...
                    Label {
                        ...
                        text: {
                            ...
                            if (accountItem.updating) {
                                ...
                                return hasPersistentConnection ? qsTrId("email-la_up_to_date")
                                                               : Utils.lastSyncTime(lastSynchronized)
                            }
                            return ""
                        }
