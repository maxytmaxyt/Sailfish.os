...
Page {
    ...
    readonly property var messageBccAddresses: message ? message.bcc : []
        ...
        Column {
            ...
            Column {
                ...
                LinkedText {
                    ...
                    plainText: message ? (message.fromAddress != ""
            ...
            MessageInfoSection {
                ...
                bodyText: calendarEvent ? (Format.formatDate(calendarEvent.startTime, Formatter.Timepoint)
                                           + " - " + Format.formatDate( calendarEvent.endTime, Formatter.Timepoint))
                                        : ""
            }
            ...
            MessageInfoRepeater {
                visible: messageBccAddresses != ""
                headerText: {
                    if (calendarEvent) {
                        // Not really sure how this should be presented on invitation case, guess sort of FYI
                        //: Bcc recipients for calendar invitation
                        //% "Copy:"
                        return qsTrId("jolla-email-la-cal-bcc_optional_info")
                    } else {
                        //: 'Bcc:' - blind carbon copy recipients label
                        //% "Bcc:"
                        return qsTrId("jolla-email-la-bcc_info")
                    }
                }
                model: messageBccAddresses
            }
