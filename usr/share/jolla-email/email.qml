...
ApplicationWindow {
            ...
            if (app.numberOfAccounts) {
                ...
                obj.pageCompleted.connect(function(page) {
                    for (var attachment in attachments) {
                        fileInfo.url = attachments[attachment]["url"]
    ...
    function showAccountsCreationDialog() {
        ...
        accountCreationLoader.setSource(pageStack.resolveImportPage("com.jolla.email.AccountCreation"),
                                        { endDestination: app._mainPage })
