...
AlarmItemBase {
    ...
    Column {
        ...
        anchors {
            ...
            horizontalCenterOffset: model.index % columnCount === 0
                                    ? Theme.paddingSmall
        ...
        TimerCircle {
            ...
            //: Can have two values: "LTR" if remaining time in timer item should be written in
            //: "[value] [unit]" order i.e. "2 min", or "RTL" i.e. right-to-left like in Arabic writing systems
            //% "LTR"
