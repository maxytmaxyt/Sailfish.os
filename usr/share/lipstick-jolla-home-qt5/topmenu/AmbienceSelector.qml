...
Item {
    ...
    SilicaListView {
        ...
        clip: Lipstick.compositor.topMenuLayer.window.orientation === Qt.LandscapeOrientation
              ...
              || page.orientationTransitionRunning
        ...
        add: Transition {
            ...
            SequentialAnimation {
                ...
                NumberAnimation {
                    property: "x"
                    from: root.itemSize * (addTransition.ViewTransition.targetIndexes[0] - 1)
                    duration: 500
        ...
        delegate: ListItem {
            ...
            Image {
                ...
                source: "image://theme/icon-s-favorite?" + (thumbnailBackground.highlighted ? Theme.highlightColor
                                                                                            : model.primaryColor)
