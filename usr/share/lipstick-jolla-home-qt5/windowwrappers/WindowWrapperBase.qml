...
FocusScope {
    ...
    readonly property int clientOrientation: window && window.surface
                ? (window.surface.contentOrientation != Qt.PrimaryOrientation ? window.surface.contentOrientation
                                                                              : QtQuick.Screen.primaryOrientation)
                : Lipstick.compositor.screenOrientation
    property int orientation: clientOrientation
