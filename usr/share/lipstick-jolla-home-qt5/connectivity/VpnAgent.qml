...
SystemWindow {
    ...
    */
    ...
    property real keyboardHeight: transpose ? Qt.inputMethod.keyboardRectangle.width
    ...
    function presentationName(received) {
        ...
        } else if (received === 'OpenVPN.Password'
                   || received === 'Password'
                   || received === 'OpenVPN.PrivateKeyPassword'
                   || received === 'OpenConnect.PKCSPassword') {
            //% "Password"
    ...
    Component {
        ...
        PasswordField {
            ...
            EnterKey.iconSource: "image://theme/icon-m-enter-" + (modelIndex == (fieldRepeater.count - 1)
                                                                  ? "close" : "next")
            ...
            Image {
                ...
                x: Math.min(_placeholderTextLabel.contentWidth + parent.textLeftMargin,
                            parent.width - parent.textRightMargin - width)
    ...
    Component {
        ...
        TextField {
            ...
            Image {
                ...
                x: Math.min(_placeholderTextLabel.contentWidth + parent.textLeftMargin,
                            parent.width - Theme.horizontalPageMargin - width)
                width: Theme.iconSizeSmall
                height: Theme.iconSizeSmall
                anchors {
                    top: parent.top
