...
Item {
    ...
    Rectangle {
        ...
        Column {
            ...
            Text { color: "white"; text: "Topmost window: "
                                         + ((compositor.topmostWindow && compositor.topmostWindow.window)
                                            ? compositor.topmostWindow.window.windowId : "") }
            Text { color: "white"; text: "Topmost window title: "
                                         + ((compositor.topmostWindow && compositor.topmostWindow.window)
                                            ? compositor.topmostWindow.window.title : "") }
        }
