            ...
            Row {
                ...
                SystemDialogIconButton {
                    ...
                    onClicked: {
                        ...
                        console.log("User terminated the unresponsive application",
                                    "\"" + dialogHeader.titleText + "\"", "with PID", window.processId)
                    }
                }
            }
        }
    ...
    Timer {
        ...
        onTriggered: {
            if (window) {
                ...
                console.log("Application", "\"" + dialogHeader.titleText + "\"", "with PID",
                            window.processId, "is not responding")
            }
        }
    }
