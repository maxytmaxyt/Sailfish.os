...
SystemWindow {
    ...
    property real reservedHeight: ((Screen.sizeCategory < Screen.Large) ? 0.2 * height
                                                                        : 0.4 * height) - 1
    ...
    SilicaFlickable {
        ...
        width: parent.width
        height: Math.min(contentHeight, root.height - root.reservedHeight)
        ...
        Column {
            ...
            Column {
                ...
                Label {
                    // Match the padding inside SystemDialogHeader
