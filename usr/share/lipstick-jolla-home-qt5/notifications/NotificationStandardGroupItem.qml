    ...
    Column {
        ...
        Item {
            ...
            property int maximumVisibleItemCount: {
                ...
                // If we have one more item than the threshold expand automatically
                // because the toggle would use the same space
            ...
            ListView {
                ...
                BoundedModel {
                    ...
                    delegate: NotificationStandardGroupMember {
                        ...
                        timestampText: notification
                                       ? (root._timestampCounter, Format.formatDate(notification.timestamp,
                                                                                    Formatter.TimeElapsedShort))
                                       : ""
