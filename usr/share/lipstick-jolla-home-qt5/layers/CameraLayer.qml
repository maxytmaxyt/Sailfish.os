...
EdgeLayer {
    ...
    // borderline whether this should be app or hw access policy.
    // using app policy to keep the UI feature consistently available regardless of hw access.
    readonly property bool canActivate: cameraLauncher.isValid && Desktop.deviceLockState <= DeviceLock.Locked
                                        && AccessPolicy.cameraAppEnabled
