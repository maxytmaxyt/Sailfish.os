...
Layer {
    ...
    property real notificationOpacity: showNotifications
                                       ? (lipstickSettings.lowPowerMode ? Theme.opacityOverlay : 1.0)
                                       : 0.0
    ...
    readonly property bool lockScreenEvents: Desktop.settings.lock_screen_events
                                             && Desktop.settings.lock_screen_events_allowed
                                             && !!eventsContainer
