...
PixelAlignedItem {
    ...
    readonly property rect backgroundRect: window && window.backgroundRect !== undefined
                                           ? window.backgroundRect : Qt.rect(0, 0, width, height)
    ...
    PeekArea {
        ...
        contentOpacity: layer.window && layer.window.hasOwnProperty("windowOpacity")
                        ? layer.window.windowOpacity : 1.0
