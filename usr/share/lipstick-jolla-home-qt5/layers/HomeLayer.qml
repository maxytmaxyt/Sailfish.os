...
Pannable {
    ...
    // iPhone-style: App Switcher requires longer upward swipe before triggering
    readonly property real _minimizeThreshold: width * (1.0 - _minimizedScale) * 0.75
    ...
    switchThreshold: dragArea.drag.threshold * 1.2  // iPhone-style: pages switch more readily
    flickDuration: 150  // iPhone-style: snappier page flick
    ...
    Item {
        ...
        StatusBar {
            ...
            y: -currentItem.statusOffset * (1.0 - homescreen.progress)
               - (alternateItem ? alternateItem.statusOffset * homescreen.progress : 0)
            updatesEnabled: Lipstick.compositor.homeActive
                            || (Lipstick.compositor.peekingLayer.exposed
                                && !Lipstick.compositor.peekingLayer.opaque)
    ...
    pannableItems: [
        ...
        SwitcherLayer {
            ...
            readonly property real inactiveScale: Lipstick.compositor.multitaskingHome
                                                  ? (Screen.sizeCategory >= Screen.Large ? 0.90 : 0.83)
                                                  : 1.0
    ...
    Component {
        ...
        PartnerLayer {
            ...
            launcherActive: launcherItem && (launcherItem.readValue("X-apkd-packageName") == ""
