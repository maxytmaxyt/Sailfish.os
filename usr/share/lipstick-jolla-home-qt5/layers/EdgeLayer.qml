...
Layer {
    ...
    transitions: [
        Transition {
            ...
            NumberAnimation {
                target: edgeLayer
                property: "x"
                duration: 220  // iPhone-style: slightly longer with spring feel
                easing.type: Easing.OutBack
                easing.overshoot: 0.5  // subtle spring overshoot like iOS
            }
            NumberAnimation {
                target: edgeLayer
                property: "y"
            ...
            NumberAnimation {
                target: edgeLayer
                property: "x"
                duration: 300  // iPhone-style: same timing, smoother curve
    ...
    SequentialAnimation {
        ...
        NumberAnimation {
            ...
            target: edgeLayer
            property: "_hintProgress"
            duration: 200  // iPhone-style: quicker hint reveal
            to: Theme.iconSizeLauncher * 1.2  // iPhone-style: subtle peek, not far
            easing.type: Easing.InOutQuad
        }
        PauseAnimation {
            id: hintPauseAnimation
