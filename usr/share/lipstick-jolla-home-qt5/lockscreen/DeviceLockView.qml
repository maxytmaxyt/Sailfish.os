...
DeviceLockInput {
    ...
    showEmergencyButton: Desktop.deviceInfo.hasCellularVoiceCallFeature
                         && (Desktop.simManager.enabledModems.length > 0 || !Desktop.simManager.ready)
    ...
    authenticationInput: DeviceLockAuthenticationInput {
        ...
        onFeedback: {
            ...
            if (feedback == AuthenticationInput.EnterSecurityCode) {
                reset()
            }
        }
