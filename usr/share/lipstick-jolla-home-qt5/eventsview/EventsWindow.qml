...
ApplicationWindow {
    ...
    initialPage: Component { Page {
        ...
        property bool lockScreenEventsActive: !!Lipstick.compositor
                                              && Lipstick.compositor.lockScreenLayer.visible
                                              && eventsContainer
                                              && eventsContainer.isCurrentItem
        ...
        property bool eventsViewActive: Lipstick.compositor.homeActive
                                        || Lipstick.compositor.homePeeking
                                        || lockScreenEventsActive
        onEventsViewActiveChanged: {
            if (eventsViewActive) {
                eventsViewInactiveTimer.stop()
            } else {
                eventsViewInactiveTimer.start()
            }
        }
