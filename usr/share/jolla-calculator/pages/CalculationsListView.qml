...
SilicaListView {
    ...
    property int primaryFontSize: coverMode ? Theme.fontSizeMedium
                                            : (pageStack.currentPage.isLandscape ? Theme.fontSizeLarge
                                                                                 : Theme.fontSizeExtraLarge)
    property int secondaryFontSize: coverMode ? Theme.fontSizeExtraSmall
                                              : (pageStack.currentPage.isLandscape ? Theme.fontSizeMedium
                                                                                   : Theme.fontSizeLarge)
    ...
    delegate: ListItem {
        ...
        Flickable {
            ...
            height: Math.max(layoutMultiplier * 1.5 * squareWidth,
                             fractionField.height + Theme.paddingSmall)
            ...
            Row {
                ...
                Repeater {
                    ...
                    Loader {
                        ...
                        sourceComponent: type == Calculation.Field
                                         ? fieldComponent
                                         : (type == Calculation.Function ? functionComponent
                                                                         : operationComponent)
                        Component {
                            id: fieldComponent
