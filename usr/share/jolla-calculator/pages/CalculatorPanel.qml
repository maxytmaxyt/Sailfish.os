            ...
            Row {
                AdvancedButton {
                    ...
                    Image {
                        ...
                        source: "image://theme/icon-m-clipboard?" + (pasteKey.highlighted ? Theme.highlightColor
                                                                                          : Theme.primaryColor)
                    }
                ...
                AdvancedButton {
                    ...
                    Image {
                        ...
                        source: "image://theme/icon-m-backspace?" + (backspaceKey.highlighted ? Theme.highlightColor
                                                                                              : Theme.primaryColor)
                    }
