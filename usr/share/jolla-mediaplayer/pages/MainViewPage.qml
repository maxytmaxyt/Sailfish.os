        ...
        header: SearchPageHeader {
            ...
            Column {
                ...
                height: {
                    ...
                    if (app.playlists.populated && playlistRow.count === 0) {
                        return height
                    } else {
                ...
                MediaContainerIconDelegate {
                    ...
                    readonly property bool populated: app.playlists.populated
                    readonly property bool createNew: app.playlists.count == 0
                    readonly property bool shouldBeVisible: app.playlists.count !== 0
                                                            || mainPageHeader.searchText === ""
                    ...
                    //: Number of playlists
                    //% "%n playlists"
                    subtitle: populated ? (!createNew ? qsTrId("mediaplayer-la-number-of-playlists",
                                                               app.playlists.count)
                                                      : "")
                                        : " "
                    onClicked: {
                        if (createNew) {
                            ...
                            pageStack.animatorPush(Qt.resolvedUrl("PlaylistsPage.qml"),
                                                   {searchText: mainPageHeader.searchText})
                        }
                    }
                }
                ...
                SilicaGridView {
                    ...
                    visible: !app.playlists.populated || count > 0

                    interactive: false
                    model: GriloTrackerModel {
                        id: playlistModel
                        query: PlaylistTrackerHelpers.getPlaylistsQuery(mainPageHeader.searchText,
                                                                        {"sortByUsage": true})
                    }
                    ...
                    delegate: PlaylistItem {
                        ...
                        function remove() {
                            remorseDelete(function() {
                                app.playlists.removePlaylist(media.url)
                            })
                        }
                    }
                }
