...
Page {
    ...
    SilicaFlickable {
        ...
        Column {
            ...
            IconTextSwitch {
                //: Label in icon text switch which allows the user to enable or disable
                //: the ambience selector in the top menu
            ...
            SettingsInfoLabel {
                ...
                //% "These sliders allow adjustments to brightness and ringtone volume levels, "
                //% "and provide access to their settings."
