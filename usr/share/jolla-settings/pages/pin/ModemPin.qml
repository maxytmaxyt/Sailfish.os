...
Column {
    ...
    TextSwitch {
        ...
        onClicked: {
            ...
            var obj = pageStack.animatorPush(Qt.resolvedUrl("PinInputPage.qml"),
                                             {"pinAction": pinAction, "ofonoSimManager": ofonoSimManager})
    ...
    Button {
        ...
        onClicked: {
            var obj = pageStack.animatorPush("PinInputPage.qml",
                                             {"pinAction": "change", "ofonoSimManager": ofonoSimManager})
            obj.pageCompleted.connect(function(page) {
                root._pinInputPage = page
            })
        }
