        ...
        Page {
            Column {
                ...
                Text {
                    ...
                    //% "Affects all contacts in the device not synced from an external service. "
                    //% "Any synced contacts can be removed by changing the settings for the relevant account."
