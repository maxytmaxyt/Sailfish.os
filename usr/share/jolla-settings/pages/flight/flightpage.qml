        ...
        IconTextSwitch {
            ...
            description: modemManager.availableModems.length > 0
                         ? //: Description for devices with mobile data capability
                           //% "Switches off cellular, WLAN and Bluetooth radios for safe usage in restricted "
                           //% "environments. WLAN or Bluetooth can be switched on separately even in airplane mode "
                           //% "if allowed in restricted environment."
                           qsTrId("settings_flight-la-flight-mode-description")
                         : //: Description for devices without mobile data capability
                           //% "Switches off WLAN and Bluetooth radios for safe usage in restricted environments. "
                           //% "WLAN or Bluetooth can be switched on separately even in airplane mode if allowed in "
