...
ApplicationSettings {
    ...
    ComboBox {
        ...
        //: Description informing the user that email client will send read receipts automatically without any
        //: additional indications if it was requested by a sender
