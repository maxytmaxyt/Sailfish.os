...
Image {
    ...
    readonly property real pageHeaderHeight: pageHeader.height
    ...
    Image {
        ...
        source: (storeIf.diskOk ? "image://theme/icon-l-battery?"
                                : "image://theme/icon-l-attention?") + Theme.lightPrimaryColor
    }
        ...
        Label {
            ...
            text: {
                if (!storeIf.diskOk) {
                    ...
                    return diskLowText.arg(Format.formatFileSize(storeIf.requiredDisk, 1))
                                      .arg(Format.formatFileSize(storeIf.availableDisk, 1))
                } else {
                    return charging
