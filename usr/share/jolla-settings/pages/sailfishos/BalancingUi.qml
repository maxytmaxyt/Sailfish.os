...
Column {
    ...
    Label {
        ...
        //% "A new OS update is around the corner.<br><br>To be able to download the OS update, we need to "
        //% "maintenance the filesystem. This requires approx. 1.5 GB of free space.<br><br>"
        //% "You will be able to use your device, but you might notice some slowdowns. "
