...
ApplicationSettings {
    ...
    Column {
        ...
        ExpandingSectionGroup {
            ...
            enabled: !mainPlaceholder.active
            ...
            Repeater {
                ...
                delegate: ExpandingSection {
                    buttonHeight: (title.length && modemManager.availableModems.length > 1)
                                  ? Theme.itemSizeMedium : 0 // hide section header if only one modem
                    ...
                    content.sourceComponent: Column {
                        ...
                        SimCardMessagingSettings {
                            enabled: !simPlaceholder.enabled && sectionGroup.enabled
                            opacity: enabled ? 1 : 0
