...
Page {
    ...
    SilicaFlickable {
        ...
        function qsTrIdStrings() {
            ...
            //% "Inverted landscape"
            QT_TRID_NOOP("settings_display-me-inverted_landscape")
        }
        ...
        ListModel {
            ...
            ListElement {
                label: "settings_display-me-inverted_landscape"
                value: "landscape-inverted"
            }
        }
        ...
        Column {
            ...
            TextSwitch {
                ...
                visible: deviceInfo.hasFeature(DeviceInfo.FeatureLightSensor)
                         && deviceInfo.hasFeature(DeviceInfo.FeatureDisplayBacklight)
                ...
                onClicked: {
                    displaySettings.autoBrightnessEnabled = !checked
                    if (!checked) {
            ...
            BrightnessSlider {
                width: parent.width
                visible: deviceInfo.hasFeature(DeviceInfo.FeatureDisplayBacklight)
            ...
            */
            ...
            TextSwitch {
                ...
                onClicked: displaySettings.inhibitMode = checked ? DisplaySettings.InhibitOff
                                                                 : DisplaySettings.InhibitStayOnWithCharger
