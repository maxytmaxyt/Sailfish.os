...
ListModel {
    ...
    Component.onCompleted: {
        ...
        items = knownItems.filter(function (item) {
            ...
            // special handling, debug info might be either in system or user partition
            if (!!item.debugInfoEntry) {
                return developerModeSettings.debugHomeEnabled == (storageType == 'user')
                        || storageType === 'mass'
            }
    ...
    property DeveloperModeSettings developerModeSettings: DeveloperModeSettings {}
}
