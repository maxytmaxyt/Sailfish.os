            ...
            SilicaFlickable {
                ...
                Column {
                    ...
                    Label {
                        ...
                        color: Theme.highlightColor
                        wrapMode: Text.Wrap
                        //% "Adding users requires enabling security code to prevent unauthorized changes "
                        //% "to the device. Security code cannot be disabled after users have been added."
            ...
            SilicaFlickable {
                ...
                Column {
                    ...
                    Label {
                        ...
                        color: Theme.highlightColor
                        font.pixelSize: Theme.fontSizeSmall
                        //% "Accepting this will remove everything the user has stored on the device "
                        //% "(e.g. accounts, contacts, messages, documents, photos and other media)."
