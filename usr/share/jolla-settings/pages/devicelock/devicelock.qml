...
Page {
    ...
    readonly property var automaticLockingOptions: [-1, 0, 1, 5, 10, 30, 60, 254]
    ...
    function automaticLockingText(minutes) {
        ...
        if (minutes == 0) {
            ...
            //% "On display off"
            return qsTrId("settings_devicelock-me-immediate")
        }
        if (minutes >= 254) {
    ...
    DeviceLockSettings {
        ...
        onMaximumAttemptsChanged: {
            attemptsSlider.value = deviceLockSettings.maximumAttempts != -1 ? deviceLockSettings.maximumAttempts
    ...
    SilicaFlickable {
        ...
        Column {
            ...
            ComboBox {
                ...
                width: parent.width
                //% "Locking"
                label: qsTrId("settings_devicelock-la-status")
                ...
                menu: ContextMenu {
                    ...
                    Repeater {
                        ...
                        MenuItem {
                            ...
                            visible: deviceLockSettings.maximumAutomaticLocking < 0
                                     || deviceLockSettings.maximumAutomaticLocking >= modelData
                        }
                    }
                }
            ...
            TextSwitch {
                ...
                visible: !securityCodeSettings.mandatory && ((!deviceLockSettings.homeEncrypted && userInfo.alone)
                                                             || !securityCodeSettings.set)
                onClicked: {
            ...
            Slider {
                ...
                visible: securityCodeSettings.set && userConfigurableMaxAttempts.value
                //% "Number of attempts"
            ...
            ConfigurationValue {
                id: userConfigurableMaxAttempts

                defaultValue: true
                key: "/jolla/devicelock/user_configurable_max_attempts"
            }
            ...
            Repeater {
                ...
                model: FolderListModel {
                    folder: "/usr/share/jolla-settings/pages/devicelock/extensions"
                    showDirs: false
                    nameFilters: ["*.qml"]
