...
SimDependentSettingsToggle {
    ...
    activeText: wifiTethering.active && networkManager.wifiClientCount > 0
        ? //: WLAN hotspot user count
          //% "%n client(s)"
          qsTrId("settings_network-la-hotspot-switch-n-clients", networkManager.wifiClientCount)
        : wifiTethering.identifier
