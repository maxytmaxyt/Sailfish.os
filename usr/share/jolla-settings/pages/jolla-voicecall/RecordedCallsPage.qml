    ...
    SilicaListView {
        ...
        delegate: ListItem {
                ...
                Row {
                    ...
                    Label {
                        ...
                        text: privateNumber ? qsTrId("voicecall-la-private_number")
                                            : (!contact.id || (contact.primaryName.length === 0
                                                               && contact.secondaryName.length === 0)
                                               ? contactLabel
                                               : contact.primaryName)
            ...
            Row {
                ...
                Image {
                    source: "image://theme/icon-s-duration" + (highlighted || delegate.selected
                ...
                Label {
                    ...
                    font.pixelSize: Theme.fontSizeExtraSmall
                    anchors.verticalCenter: parent.verticalCenter
                    text: Format.formatDuration(duration, duration >= 3600
                                                ? Formatter.DurationLong : Formatter.DurationShort)
                }
            }
        }
