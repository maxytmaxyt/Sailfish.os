...
Column {
    ...
    property QtObject recordingsModel: recordingsModelLoader.status == Loader.Ready
                                       ? recordingsModelLoader.item : null
    ...
    function showRecordingsImmediately() {
        recordingsModelLoader.sourceComponent = recordingsModelComponent
        pageStack.push("RecordedCallsPage.qml",
                       { model: Qt.binding(function() { return recordingsModelLoader.item }) },
    ...
    TextSwitch {
        ...
        description: AccessPolicy.microphoneEnabled
                     ...
                     : //: %1 is an operating system name without the OS suffix
                       ...
                       qsTrId("settings_phone-la-call_recording_not_supported_disabled_by_mdm").arg(
    ...
    TextSwitch {
        ...
        text: qsTrId("settings_phone-la-call_record_automatically")
        checked: automaticCallRecordingConfig.value
        automaticCheck: false
        enabled: callRecordingSwitch.checked

        onClicked: automaticCallRecordingConfig.value = !checked

        ConfigurationValue {
            id: automaticCallRecordingConfig

            key: "/jolla/voicecall/automatic_call_recording"
            defaultValue: false
        }
    }
    ...
    BackgroundItem {
        ...
        onClicked: {
            ...
            pageStack.animatorPush("RecordedCallsPage.qml", { model: recordingsModel })
        }
    }
