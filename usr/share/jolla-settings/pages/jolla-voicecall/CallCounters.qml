...
Column {
    ...
    DBusInterface {
        ...
        property int dialledDuration
        property int receivedDuration
        property int ongoingDialledDuration
        property int ongoingReceivedDuration
        ...
        property bool activeCallIncoming
