...
Page {
    ...
    readonly property bool hasDeveloperAccount: accountManager
                                                ? accountManager.hasAccountForProvider(accountManager.accountIdentifiers, developerAccountProvider)
                                                : true
...
//    DummyDeveloperModeSettings {  // Replace for mock backend to test UI
    ...
    NetworkManager {
        id: networkManager
        readonly property bool online: globalState == NetworkManager.OnlineState
    }
    ...
    function goOnline(callback) {
        connectionSelector.goOnline(callback)
    }
        ...
        Column {
                ...
                onClicked: {
                    if (developerModeSettings.developerModeEnabled) {
                        ...
                        if (developerModeSettings.repositoryAccessRequired) {
                            goOnline(function() { root.authenticate(showDisclaimerDialog, false) })
                        } else {
            ...
            Column {
                ...
                TextSwitch {
                    ...
                    onClicked: {
                        if (checked) {
                            ...
                            var remorse = Remorse.popupAction(root, qsTrId("settings_developermode-la-disabled_remote_connection"),
                                                              function() {
                                passwordManager.call('setRemoteLoginEnabled', [false])
                            })
                ...
                Column {
                    ...
                    SystemPasswordField {
                        ...
                        showEchoModeToggle: ((!usePlaceholderPassword || text != '') && activeFocus)
                                            || (passwordManager.passwordIsGenerated && storedByManager)
                    ...
                    ButtonLayout {
                        ...
                        Button {
                            ...
                            readonly property bool clear: passwordField.storedByManager
                                                          && passwordManager.passwordLoginEnabled
                                                          || !passwordField.storedByManager && passwordField.text == ''
            ...
            Column {
                ...
                TextSwitch {
                    ...
                    onClicked: {
                        if (ssu.registered) {
                            ...
                            var remorse = Remorse.popupAction(root,
                                                              qsTrId("settings_developermode-la-disabled_developer_updates"),
                                                              function() {
                                ssu.unregister()
                            })
                    ...
                    description: ssu.registered
                                 ? //% "Successfully registered with SSU in '%0' domain"
                                   qsTrId("settings_developermode-la-ssu_enabled").arg(ssu.currentDomain)
            ...
            Column {
                ...
                TextSwitch {
                    ...
                    onClicked: {
                        ...
                        var text = developerModeSettings.debugHomeEnabled
                                ? //% "Moving debug symbols from home partition"
                                  qsTrId("settings_developermode-la-disabled_debug_home")
