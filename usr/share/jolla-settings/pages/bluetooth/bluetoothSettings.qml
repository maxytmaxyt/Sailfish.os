...
Page {
    ...
    readonly property bool _bluetoothPoweredOn: btTech.available && btTech.powered
    ...
    function _checkAutoStartDiscovery() {
        if (_autoStartDiscovery) {
            if (btTech.available && !btTech.powered) {
                btTech.powered = true
    ...
    SilicaFlickable {
        ...
        BluetoothViewPlaceholder {
            ...
            enabled: !btTech.available && root.status === PageStatus.Active
        }
