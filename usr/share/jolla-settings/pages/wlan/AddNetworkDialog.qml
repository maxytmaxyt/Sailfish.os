    ...
    SilicaFlickable {
        ...
        Column {
            ...
            SsidField {
                ...
                EnterKey.iconSource: nextFocusItem !== parent
            ...
            ClientCertChooser {
                ...
                onKeyFromFileSelected: pageStack.push(filePickerPage,
                                                      { fieldName: 'privateKeyFile',
                                                          nameFilters: ['*.pem', '*.key', '*.p12', '*.pfx'] })
                onCertFromFileSelected: pageStack.push(filePickerPage,
                                                       { fieldName: 'clientCertFile',
                                                           nameFilters: ['*.pem', '*.crt'] })
    ...
    Component {
        ...
        FilePickerPage {
            ...
            onSelectedContentPropertiesChanged: {
                network[fieldName] = CertHelper.readCert(selectedContentProperties.filePath, 'CERTIFICATE')
            }
        }
    }
