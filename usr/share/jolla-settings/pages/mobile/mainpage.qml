    ...
    SilicaFlickable {
        ...
        Column {
            ...
            Column {
                ...
                property bool topSettingsAvailable: root.pageReady && (!Telephony.multiSimSupported
                                                                       || sailfishSimManager.availableSimCount > 0)
            ...
            Repeater {
                ...
                delegate: Column {
                    ...
                    SectionHeader {
                        text: Telephony.multiSimSupported
                    ...
                    SimSectionPlaceholder {
                        ...
                        // single-modem mode uses full-page placeholder instead
                        modemPath: Telephony.multiSimSupported ? modelData : ""
                    ...
                    SimMobileNetworkSettings {
                        ...
                        opacity: disabledByMdmBanner.active ? (Theme.opacityHigh - simPlaceholder.opacity)
                                                            : (1 - simPlaceholder.opacity)
                        modemPath: modelData
