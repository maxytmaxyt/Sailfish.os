...
Page {
    ...
    readonly property bool batteryOk: !deviceInfo.hasFeature(DeviceInfo.FeatureBattery)
                                      || batteryStatus.chargePercentage > batteryThreshold
    ...
    Component.onCompleted:  {
        try {
            ...
            console.log("Vault not present, not using backup link on reset page")
        }
    }
    ...
    function createBackupLink() {
        ...
        return vaultPresent ? "<a href='backup'>" + backup + "</a>"
                            : backup
    }
    ...
    Column {
        ...
        Label {
            ...
            //% "This means losing everything you have added to the device, including updates, applications, "
            //% "accounts, contacts, photos and other media.<br><br>"
            ...
            onLinkActivated: pageStack.animatorPush("Sailfish.Vault.BackupPage")
        }
            ...
            SilicaFlickable {
                ...
                Column {
                    ...
                    Label {
                        ...
                        //: Takes "Back up" (settings_reset-la-back_up) formatted hyperlink as parameter.
                        //: This is done because we're creating programmatically a hyperlink for it.
                        //% "Accepting this erases everything from your device and reverts "
                        //% "the software back to factory state. "
                        //% "This means losing everything you have added to the device "
                        //% "(e.g. updates, applications, accounts, contacts, photos and other media). "
                        //% "%1 files to memory card.<br><br>"
                        //% "When erasing, device will shut down automatically and the next "
                        //% "boot up might take longer than usual."
                    ...
                    TextSwitch {
                        ...
                        //% "A normal factory reset will take closer to 5 minutes but some data may still be "
