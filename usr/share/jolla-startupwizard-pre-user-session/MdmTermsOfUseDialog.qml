...
Dialog {
    ...
    Flickable {
        ...
        DialogHeader {
            ...
            dialog: root
            // translation string defined in WizardDialogHeader
            cancelText: startupWizardManager.translatedText("startupwizard-he-previous_page", root.localeName)
            acceptText: startupWizardManager.translatedMdmText(mdmTerms.translationIds["triggerAccept"],
                                                               root.localeName)
        }
