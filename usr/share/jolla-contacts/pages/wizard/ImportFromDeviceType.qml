    ...
    SilicaFlickable {
        ...
        Column {
            ...
            Label {
                ...
                text: {
                    if (deviceType == 'android') {
                        //% "Your contacts are probably automatically synchronized to your Google account. "
                        //% "You can check this easily on your Android phone by going to "
                        //% "'Settings / Accounts / Google'.<br>"
                        //% "<br>"
                        //% "If the 'Sync contacts' option is selected, your contacts are available from your "
                        //% "Google account and you can add this account to your device in 'Settings / Accounts' "
                        //% "to sync your contacts.<br>"
                        //% "<br>"
                        //% "If 'Sync contacts' is not selected, you can select it then start a sync on your Android, "
                        //% "then add your Google account to your device.<br>"
            ...
            LinkButton {
                ...
                link: helpArticles.setup_google_account_link
                      ...
                      : 'https://docs.sailfishos.org/Support/Help_Articles/Accounts_Setup/Setup_Google_Account/'
            ...
            Label {
                ...
                //% "If your contacts are not synchronized to a Google account and you don't want to "
                //% "use synchronization, you can create a contacts file (.vcf) and transfer that to your device."
                ...
                link: {
                    if (deviceType == 'android') {
                        return helpArticles.import_android_link
                               ...
                               : 'https://docs.sailfishos.org/Support/Help_Articles/Importing_Contacts/'
                    } else if (deviceType == 'iphone') {
