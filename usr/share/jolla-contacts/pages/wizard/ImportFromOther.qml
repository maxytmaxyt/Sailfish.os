    ...
    SilicaFlickable {
        ...
        Column {
            ...
            Label {
                ...
                //% "If you can't or don't want to use service synchronization from your old phone, you can either "
                //% "transfer your contacts via SIM card or by creating a contacts file and transferring that to "
                //% "your device. If you already have one or more vCard files on your device or a memory card, "
